...
发给有 macbook 的学长测试了一下，结果发现跑不起来，查阅问题发现是 [metal 只接受带有 alpha 通道的颜色格式](https://github.com/google-ai-edge/mediapipe/issues/5265)，导致 gpu 加速的时候出现了图像帧格式不兼容的问题，遂加上特判。
